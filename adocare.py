...
Original file is located at
    https://colab.research.google.com/drive/1zg1f3UuxQ1D79LnQHIwQG_nUFkPHMZrv

# ***MSBA316-Text Analytics & NLP Project***

*   The main objective of this project is to design a ChatBot that will provide
equitable and accessible sexual and reproductive health information and services to adolescents in Lebanon.

*   We will be utilizing the Langchain framework, which integrates our document sources alongside the robust capabilities of the OpenAI language model (LLM)

# Installing dependencies, Importing Libraries & Setting OpenAI key
"""
